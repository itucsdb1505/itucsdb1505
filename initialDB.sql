...
INSERT INTO COUNTRIES(NAME, POPULATION, COORDINATES) values('Turkiye',30000,1);
INSERT INTO COUNTRIES(NAME, POPULATION, COORDINATES) values('Amerika',70000,3);
INSERT INTO COUNTRIES(NAME, POPULATION, COORDINATES) values('GuneyAfrika',80000,5);

DROP TABLE IF EXISTS LEAGUES;
CREATE TABLE LEAGUES(ID SERIAL PRIMARY KEY, NAME TEXT NOT NULL, NATION TEXT NOT NULL, CLASSIFICATION INT NOT NULL);
INSERT INTO LEAGUES(NAME, NATION, CLASSIFICATION) values('Lig','Türkiye',1);
INSERT INTO LEAGUES(NAME, NATION, CLASSIFICATION) values('BankAsya','Turkiye',2);
