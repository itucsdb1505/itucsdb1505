...
CREATE TABLE USERS(ID SERIAL PRIMARY KEY, NAME TEXT, AGE INT, EMAIL CHAR(50), PASSWORD TEXT, AUTH CHAR,  COUNTRY_ID INT);
...
INSERT INTO USERS(NAME, AGE, EMAIL, PASSWORD, AUTH, COUNTRY_ID) values('Emre EROĞLU', 28, 'emreeroglu@itu.edu.tr', '1', 'a', 1);
INSERT INTO USERS(NAME, AGE, EMAIL, PASSWORD, AUTH, COUNTRY_ID) values('abcd', 45, 'abcd@itu.edu.tr', '1', 'u', 2);
INSERT INTO USERS(NAME, AGE, EMAIL, PASSWORD, AUTH, COUNTRY_ID) values('efgh', 85, 'efgh@itu.edu.tr', '1', 'm', 3);
INSERT INTO USERS(NAME, AGE, EMAIL, PASSWORD, AUTH, COUNTRY_ID) values('jklm', 20, 'jklm@itu.edu.tr', '1', 'a', 3);
