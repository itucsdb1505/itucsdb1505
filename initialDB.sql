...
CREATE TABLE COUNTRIES(NAME CHAR(50) NOT NULL, POPULATION INT, COORDINATES INT SET DEFAULT 0,ID INT );
...
CREATE TABLE LEAGUES( NAME CHAR(75) NOT NULL, NATION VARCHAR(50) NOT NULL, CLASSIFICATION INT,ID INT);
INSERT INTO LEAGUES values('SuperLig','Turkiye',1);
