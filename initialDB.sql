...
CREATE TABLE COUNTRIES(ID INT, NAME TEXT, POPULATION INT);
INSERT INTO COUNTRIES values(1, 'ANKARA',3000000);
INSERT INTO COUNTRIES values(2, 'ISTANBUL',7000000);
INSERT INTO COUNTRIES values(3, 'TRABZON',800000);
