...
CREATE TABLE COUNTRIES(ID SERIAL PRIMARY KEY, NAME TEXT NOT NULL, POPULATION FLOAT NOT NULL, COORDINATES FLOAT);
INSERT INTO COUNTRIES values('Turkiye',30000,1);
INSERT INTO COUNTRIES values('Amerika',70000,3);
INSERT INTO COUNTRIES values('GuneyAfrika',80000,5);

DROP TABLE IF EXISTS LEAGUES;
CREATE TABLE LEAGUES(ID SERIAL PRIMARY KEY, NAME TEXT NOT NULL, NATION TEXT NOT NULL, CLASSIFICATION INT NOT NULL);
INSERT INTO LEAGUES values('Lig','Türkiye',1);
INSERT INTO LEAGUES values('BankAsya','Turkiye',2);